...
<%-- <div class="form-group">
	<label class="table_font">Comment:</label>
...
<div class="center2">
	<input type="hidden" id="rqNo" value="${requestCo.rqNo}" />
	 <input type="hidden" id="userid" 
		value="${sessionScope.userDTO.userId}" />
	 <input type="button" value="확인" align="right" id="createbtn"
		onclick="doCreateReply();" />
