...
public interface UserDAOInterface {
	...
	public List<RequestNoticeDTO> userSelectByMyRequestWirteP(String userId, int requestlow, int requesthigh);
	...
	public List<MessageDTO> selectReceiveMessageP(String userId, int low, int high);
